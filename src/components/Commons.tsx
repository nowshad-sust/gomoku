...
export const Equal: FC = () => (
    <img
        alt="equal"
        src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABoAAAAaCAYAAACpSkzOAAAABmJLR0QA/wD/AP+gvaeTAAAAUklEQVRIiWNgGAWjYNgCRmTOcx/bUwwM/02pZPJJyc1HLGBcJlRZKlnCwMDA8J/BHJnLhEsdtQG6RaeoaPYJKpo1CugARvMR2WA0H42CUUA5AABnNRQHeq4tUQAAAABJRU5ErkJggg=="
    />
);
